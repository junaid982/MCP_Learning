...
# Simple SSE Server with basic tools 

# SSE Stands for "Server Sent Event"
# It’s a way for a server to push updates to the client over HTTP in real-time. Unlike WebSockets (which are bidirectional), SSE is one-way:
